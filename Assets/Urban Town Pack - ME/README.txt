...
4rd This package Initializes vertex painting so you can use your vertex painter of choice or this one: https://github.com/slipster216/VertexPaint.
5th To get the full potential of this package it is recommended that you use Post Processing Stack from Unity: https://assetstore.unity.com/packages/essentials/post-processing-stack-83912 if you opt to use Post procesing stack, You will find a unity package named "ColorGrading(Import if needed)" in the main package directory. It contains 6 presets for color grading with LUT.
6th Enjoy.
...
We have been licensed to distribut the "VertexInstanceStream.cs" under the custom license. for more information please refer to the Third-Party Notices.txt in the main directory of the package. You can access the VertexPaint via the Offical GitHub link https://github.com/slipster216/VertexPaint.
